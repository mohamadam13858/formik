                    ...
                    <div className='auth_box col-11 col-md-8 col-lg-6 col-xl-4 py-4 px-3'>
                        <Form className='row'>
                            ...
                            <div className="mb-3 col-6">
                                ...
                                <FastField type="text" className="form-control" id="postalcode" name='addres.postalcode' />
                                <ErrorMessage name='addres.postalcode'>
                                    {error => <small className='d-block text-center text-danger'>{error}</small>}
                                </ErrorMessage>
                            </div>
                            <div className="mb-3 col-6">
                                <label htmlFor="city" className="form-label">شهر</label>
                                <FastField type="text" className="form-control" id="city" name='addres.city' />
                                <ErrorMessage name='addres.city'>
                                    {error => <small className='d-block text-center text-danger'>{error}</small>}
                                </ErrorMessage>
                            </div>
                            <div className="mb-3 col-6">
                            ...
                            <div className="mb-3">
                                <FieldArray type="text" className="form-control mb-3" id="favorits" name='favorits'>
